/**
 * Punto de entrada de las features de negocio de la aplicación (ver
 * docs/architecture.md, capas 3-5): cada subcarpeta (`scan/`, `history/`,
 * `report/`) agrupa la UI y lógica propia de un flujo de RF completo.
 *
